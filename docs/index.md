# 🎬 imdbinfo
### Fast & Lightweight Python Client for IMDb Metadata (No API Keys Required)
...
[![GitHub Stars](https://img.shields.io/github/stars/tveronesi/imdbinfo?style=flat-square)](https://github.com/tveronesi/imdbinfo)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](https://github.com/tveronesi/imdbinfo/blob/main/LICENSE)

**`imdbinfo`** is an easy-to-use Python library designed to search and fetch comprehensive, structured metadata from IMDb — including movies, TV series, episodes, cast, crew, filmographies, awards, character quotes, user reviews, trivia, parental guides, media galleries, and more — **with no API keys or authentication credentials needed**.
...
This project and its authors are not affiliated with, endorsed by, or sponsored by IMDb.com, Inc. or Amazon.com. All product and company names are trademarks or registered trademarks of their respective holders. For more details, see [DISCLAIMER.txt](https://github.com/tveronesi/imdbinfo/blob/main/DISCLAIMER.txt).
...
Please review our [Contributing Guidelines](https://github.com/tveronesi/imdbinfo/blob/main/CONTRIBUTING.md) and [Code of Conduct](https://github.com/tveronesi/imdbinfo/blob/main/CODE_OF_CONDUCT.md) before submitting contributions.

If you find `imdbinfo` helpful, please consider giving the repository a ⭐ on [GitHub](https://github.com/tveronesi/imdbinfo)!

---

## 📄 License

`imdbinfo` is distributed under the terms of the [MIT License](https://github.com/tveronesi/imdbinfo/blob/main/LICENSE).
